...
Im 1. und 2. Semester: min-7 & max-9; Im 3. Semester: min-3 & max-5";
        ...
        ###### MODULE AVERAGE            
            ...
            $pdf->SetFont('Univers57cn','b',$courseSize);
            if ($lastmod != "Language") $pdf->Cell(20,7, number_format( $module_ects, 1), 1, 0, 'C');
            else $pdf->Cell(20,7, number_format( $ects_sum_languages, 1), 1, 0, 'C');
 ...
 $query_check = "SELECT status, modul, university, coursename, credits, MIN(local_grade) as local_grade, MIN(ects_grade) as ects_grade FROM amase_grades WHERE student_id='$id' 
	...
	foreach ($parse_modul_new as $Mcourse){
        ...
        $result_partner_uni = mysql_query($query_partner_uni) OR die("Error: could not retrieve grades from database: " . mysql_error());
		  ...
		  while($row = mysql_fetch_assoc($result_partner_uni)) { 
		   $row['credits']= ereg_replace(",", ".", $row['credits']);
           $row['local_grade']= ereg_replace(",", ".", $row['local_grade']);
		   if($row['university']=="LTU")
				{ 
				   if( $row['local_grade'] == '5.0')
				      {
					   $row['local_grade'] = '1.0';
					   }
				  elseif( $row['local_grade'] == '4.0')
				      {
					   $row['local_grade'] = '1.7';
					   }
				 elseif( $row['local_grade'] == '3.0')
				      {
					   $row['local_grade'] = '2.3';
					   }
				 elseif( $row['local_grade'] == '2.0')
				      {
					   $row['local_grade'] = '3.0';
					   }
			     elseif( $row['local_grade'] == '1.0')
				      {
					   $row['local_grade'] = '3.7';
					   }
				}
				elseif($row['university']=="UPC")
				{ 
				   if( $row['local_grade'] == '9.8' || $row['local_grade'] == '9.9' || $row['local_grade'] == '10.0')
				      {
					   $row['local_grade'] = '1.0';
					   }
				  elseif( $row['local_grade'] == '9.2' || $row['local_grade'] == '9.3' || $row['local_grade'] == '9.4' || $row['local_grade'] == '9.5' || $row['local_grade'] == '9.6' || $row['local_grade'] == '9.7' )
				      {
					   $row['local_grade'] = '1.3';
					   }
				 elseif( $row['local_grade'] == '8.6' || $row['local_grade'] == '8.7' || $row['local_grade'] == '8.8' || $row['local_grade'] == '8.9' || $row['local_grade'] == '9.0' || $row['local_grade'] == '9.1' )
				      {
					   $row['local_grade'] = '1.7';
					   }
				 elseif( $row['local_grade'] == '8.1' || $row['local_grade'] == '8.2' || $row['local_grade'] == '8.3' || $row['local_grade'] == '8.4' || $row['local_grade'] == '8.5' || $row['local_grade'] == '8.6' )
				      {
					   $row['local_grade'] = '2.0';
					   }
			     elseif( $row['local_grade'] == '7.5' || $row['local_grade'] == '7.6' || $row['local_grade'] == '7.7' || $row['local_grade'] == '7.8' || $row['local_grade'] == '7.9' || $row['local_grade'] == '8.0' )
				      {
					   $row['local_grade'] = '2.3';
					   }
				elseif( $row['local_grade'] == '7.0' || $row['local_grade'] == '7.1' || $row['local_grade'] == '7.2' || $row['local_grade'] == '7.3' || $row['local_grade'] == '7.4')
				      {
					   $row['local_grade'] = '2.7';
					   }
				elseif( $row['local_grade'] == '6.5' || $row['local_grade'] == '6.6' || $row['local_grade'] == '6.7' || $row['local_grade'] == '6.8' || $row['local_grade'] == '6.9')
				      {
					   $row['local_grade'] = '3.0';
					   }
				elseif( $row['local_grade'] == '5.9' || $row['local_grade'] == '6.0' || $row['local_grade'] == '6.1' || $row['local_grade'] == '6.2' || $row['local_grade'] == '6.3' || $row['local_grade'] == '6.4' )
				      {
					   $row['local_grade'] = '3.3';
					   }
				elseif($row['local_grade'] == '5.3' || $row['local_grade'] == '5.4' || $row['local_grade'] == '5.5' || $row['local_grade'] == '5.6' || $row['local_grade'] == '5.7' || $row['local_grade'] == '5.8' )
				      {
					   $row['local_grade'] = '3.7';
					   }
				elseif($row['local_grade'] == '5.0' || $row['local_grade'] == '5.1' || $row['local_grade'] == '5.2' )
				      {
					   $row['local_grade'] = '4.0';
					   }
				}
				elseif($row['university']=="UL")
				{
				if( $row['local_grade'] == '16.0')
				      {
					   $row['local_grade'] = '1.0';
					   }
				  elseif( $row['local_grade'] == '15.0')
				      {
					   $row['local_grade'] = '1.3';
					   }
				 elseif( $row['local_grade'] == '14.0')
				      {
					   $row['local_grade'] = '2.0';
					   }
				 elseif( $row['local_grade'] == '13.0')
				      {
					   $row['local_grade'] = '2.3';
					   }
			     elseif( $row['local_grade'] == '12.0')
				      {
					   $row['local_grade'] = '3.0';
					   }
				elseif( $row['local_grade'] == '11.0')
				      {
					   $row['local_grade'] = '3.3';
					   }
				elseif( $row['local_grade'] == '10.0')
				      {
					   $row['local_grade'] = '4.0';
					   }
    ...
    foreach ($parse_modul as $Mcourse) {
        ...
        ###### MODULE AVERAGE            
            ...
            if ($module_summe_gradedEcts != 0.0)  $pdf->Cell(20,8, substr( ($module_summe_gradesXEctsGrades/$module_summe_gradedEcts), 0, 3),1,0,'C');
