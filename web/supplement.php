...
<body align="center">
    <form class="form-horizontal" action="supplement.php?id='.$id.'" method="post">
        <fieldset>
            ...
            <!-- Text input-->
            <div class="form-group">
              <label class="col-md-4 control-label" for="issuedate">Datum der letzten Prüfungsleistung</label>  
              <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4">
                <select id="line6choice" name="line6choice" class="form-control">
                  ...
                  <option value="b">Expedición de titulos académicos - UPC</option>
                  <option value="c">Attestation de réussite au diplome - UL</option>
                </select>
              </div>
            </div>
        ...
        if($line6choice == "a"){
            ...
            $line6choice = "Expedición de titulos académicos - UPC";
        }elseif($line6choice == "c"){
            $line6choice = "Attestation de réussite au diplome - UL";
        }
